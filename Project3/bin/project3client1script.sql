#  The client user execution script for Project Three - CNT 4714 - Spring 2026
...
#Command 4 - project3:
#   Query: Which rider won the 2025 Tour de France?
select ridername
from racewinners
where racename = "Tour de France" and raceyear = 2025;
